...
<section class="courses">
   ...
   <h1 class="heading">Playlists enregistrer</h1>
   ...
   <div class="box-container">
      ...
      <?php
               ...
               echo '<p class="empty">Formation non trouver</p>';
            }
         }
      }else{
         echo '<p class="empty">Aucune formation enregistrer pour le moment</p>';
      }
      ?>
