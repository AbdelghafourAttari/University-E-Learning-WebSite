   ...
   <div class="row">
      ...
      <div class="col">
         <form action="" method="post" class="save-list">
            ...
            ?>
            <button type="submit" name="save_list"><i class="fas fa-bookmark"></i><span>Enregistrer</span></button>
            <?php
               }else{
            ?>
               <button type="submit" name="save_list"><i class="far fa-bookmark"></i><span>Enregistrer la playlist</span></button>
            <?php
               }
            ?>
         </form>
      ...
      <?php
            ...
            echo '<p class="empty">Playlist non trouver</p>';
         }  
      ?>
...
<section class="videos-container">
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">Aucune video est ajouter</p>';
         }
      ?>
