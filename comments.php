...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'commentaire vien d etre supprimé';
   }
...
<section class="edit-comment">
   <h1 class="heading">Modifier un commentaire</h1>
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="comments.php" class="inline-option-btn">Annuler</a>
...
<section class="comments">
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         <div class="content"><span><?= $fetch_comment['date']; ?></span><p> - <?= $fetch_content['title']; ?> - </p><a href="watch_video.php?get_id=<?= $fetch_content['id']; ?>">Voir </a></div>
      ...
      <?php
         ...
         echo '<p class="empty">Aucun commentaire trouver</p>';
      }
      ?>
      </div>
