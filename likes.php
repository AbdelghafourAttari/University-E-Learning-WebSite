...
<section class="liked-videos">
   ...
   <h1 class="heading">Videos likées</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Voir la video</a>
         <input type="submit" value="retirer" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
         }else{
            echo '<p class="emtpy">contenu non trouver</p>';         
         }
      }
   }else{
      echo '<p class="empty">Aucun titre likées</p>';
   }
   ?>
