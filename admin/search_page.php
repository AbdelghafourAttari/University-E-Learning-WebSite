...
if(isset($_POST['delete_playlist'])){
   ...
   $message[] = 'playlist supprimer';
   }else{
      $message[] = 'playlist deja supprimer';
   }
}
...
<section class="contents">
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('voulez-vous supprimer ce contenu?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Aucune formation touver</p>';
      }
   }else{
      echo '<p class="empty">Rechercher</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('voulez-vous supprimer cet playlist?');" name="delete">
         </form>
      ...
      <?php
         ...
         echo '<p class="empty">Aucune playlist trouver</p>';
      }}else{
         echo '<p class="empty">Rechercher</p>';
      }
      ?>
