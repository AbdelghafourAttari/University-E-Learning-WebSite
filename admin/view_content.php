...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Commentaire déja supprimer';
   }
   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('Vous-voulez supprimer cette video?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">Aucun contenu ajouter <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">add videos</a></p>';
   }
...
<section class="comments">
   ...
   <h1 class="heading">Commentaire</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Vous-voulez supprimer ce commentaire?');">Supprimer</button>
         </form>
      </div>
      <?php
       }
