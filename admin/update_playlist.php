...
<section class="playlist-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="enter un titre pour la playlist" value="<?= $fetch_playlist['title']; ?>" class="box">
      <p>description de la playlist<span>*</span></p>
      <textarea name="description" class="box" required placeholder="Ajouter une description" maxlength="1000" cols="30" rows="10"><?= $fetch_playlist['description']; ?></textarea>
      ...
      <div class="flex-btn">
         <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('Voulez-vous supprimer cette playlist?');" name="delete">
   ...
   <?php
      ...
      echo '<p class="empty">Aucun playlist ajouter</p>';
   }
   ?>
