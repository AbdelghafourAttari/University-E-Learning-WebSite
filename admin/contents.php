...
<section class="contents">
   ...
   <h1 class="heading">Mon contenu</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Ajouter une nouvelle formation</h3>
      <a href="add_content.php" class="btn">Ajouter</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Voir la video</a>
      </div>
   <?php
         }
      }else{
