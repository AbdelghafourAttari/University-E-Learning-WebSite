...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         ...
         $message[] = 'Mot de passe pas confirmer';
      }else{
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="old_pass" placeholder="enter votre ancien mot de passe" maxlength="20"  class="box">
            <p>Nouveau mot de passe</p>
            <input type="password" name="new_pass" placeholder="enter un nouveau mot de passe" maxlength="20"  class="box">
            <p>Confirmer le mot de passe</p>
            <input type="password" name="cpass" placeholder="confirmer votre mot de passe" maxlength="20"  class="box">
         </div>
      </div>
      <p>Modifier votre image</p>
