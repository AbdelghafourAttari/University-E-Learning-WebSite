...
<section class="video-form">
   ...
   <h1 class="heading">Modifier la formation</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>Modifier la status <span>*</span></p>
      <select name="status" class="box" required>
         <option value="<?= $fecth_videos['status']; ?>" selected><?= $fecth_videos['status']; ?></option>
         <option value="active">activer</option>
         <option value="deactive">desactiver</option>
      </select>
      <p>Modifier le title <span>*</span></p>
      <input type="text" name="title" maxlength="100" required placeholder="enter le titre de la video" class="box" value="<?= $fecth_videos['title']; ?>">
      <p>Modifier la description <span>*</span></p>
      <textarea name="description" class="box" required placeholder="Ajouter une description" maxlength="1000" cols="30" rows="10"><?= $fecth_videos['description']; ?></textarea>
      <p>Modifier la playlist</p>
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>Choisir une playlist</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>Aucune playlist creer</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>Modifier la miniature</p>
      <input type="file" name="thumb" accept="image/*" class="box">
      <video src="../uploaded_files/<?= $fecth_videos['video']; ?>" controls></video>
      <p>Modifier la video</p>
      <input type="file" name="video" accept="video/*" class="box">
      <input type="submit" value="Modifier" name="update" class="btn">
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">Voir la video</a>
         <input type="submit" value="Supprimer" name="delete_video" class="delete-btn">
      </div>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">video non trouver <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">ajouter une video</a></p>';
      }
   ?>
