...
if(isset($_POST['delete_video'])){
   ...
   if($verify_video->rowCount() > 0){
      ...
      $message[] = 'video supprimer';
   }else{
      $message[] = 'video déja supprimer';
   }
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('Voulez-vous supprimercette playlist?');" name="delete">
         </form>
      </div>
   </div>
   <?php
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Supprimer" class="delete-btn" onclick="return confirm('Voulez-vous upprimer cette video?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">Regarder la video</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">Aucun video trouver <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">Ajouter une video</a></p>';
      }
   ?>
