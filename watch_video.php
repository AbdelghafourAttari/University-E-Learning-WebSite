...
if(isset($_POST['like_content'])){
   ...
   if($user_id != ''){
      ...
      if($select_likes->rowCount() > 0){
         ...
         $message[] = 'Retirer des titres likées';
      }else{
         ...
         $message[] = 'Ajouter aux titres likées';
      }
   ...
   if($user_id != ''){
      ...
      if($select_content->rowCount() > 0){
         ...
         if($select_comment->rowCount() > 0){
            $message[] = 'Commentaire vien detre ajouter';
         }else{
            ...
            $message[] = 'nouveau commentaire ajouter';
         }
...
if(isset($_POST['delete_comment'])){
   ...
   if($verify_comment->rowCount() > 0){
      ...
      $message[] = 'Commentaire vien detre supprimer';
   }
...
<section class="edit-comment">
   <h1 class="heading">Modifier le commentaire</h1>
   <form action="" method="post">
      <input type="hidden" name="update_id" value="<?= $fetch_edit_comment['id']; ?>">
      <textarea name="update_box" class="box" maxlength="1000" required placeholder="entrer votre commentaire" cols="30" rows="10"><?= $fetch_edit_comment['comment']; ?></textarea>
      <div class="flex">
...
<section class="watch-video">
   ...
   <div class="video-details">
      ...
      <form action="" method="post" class="flex">
         ...
         <a href="playlist.php?get_id=<?= $fetch_content['playlist_id']; ?>" class="inline-btn">Voir playlist</a>
         <?php
            if($verify_likes->rowCount() > 0){
         ?>
         <button type="submit" name="like_content"><i class="fas fa-heart"></i><span>likée</span></button>
         <?php
         }else{
         ?>
   ...
   <?php
         ...
         echo '<p class="empty">Aucune video ajouter</p>';
      }
   ?>
...
<section class="comments">
   ...
   <form action="" method="post" class="add-comment">
      ...
      <textarea name="comment_box" required placeholder="ecrire ton commentaire" maxlength="1000" cols="30" rows="10"></textarea>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">Modifier</button>
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('Voulez-vous supprimer ce commentaire?');">Supprimer</button>
         </form>
         <?php
         }
         ?>
      ...
      <?php
         ...
         echo '<p class="empty">Aucun commentaire</p>';
      }
      ?>
      </div>
